...
Gamer.prototype.getProfile = function() {
	...
	await var moPull =  moStat();

	var moPullReport = moPull;
	console.log(moPullReport);

	var totalHash = moPull.totalHash;
