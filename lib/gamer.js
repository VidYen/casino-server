...
Gamer.prototype.getProfile = function() {
	...
	//This is VidYen code
 	var url = 'https://api.moneroocean.stream/miner/' + '8BpC2QJfjvoiXd8RZv3DhRWetG7ybGwD8eqG9MZoZyv7aHRhPzvrRF43UY1JbPdZHnEckPyR4dAoSSZazf5AY5SS9jrFAdb' + '/stats/' + gamer.uid;

	var hash = request.post(url, {form:{key:'totalHash'}});
